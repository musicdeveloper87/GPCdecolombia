...
   </li>
 <li class="nav-item ">
    <a class="nav-link" style="color:white" href="Usuario.php">INICIO</a>
   </li>
<li class="nav-item ">
            <a class="nav-link text-right" style="color:white" href="salir.php">SALIR</a>
        </li>
   </ul>
</nav>
...
<div class="row">
  ...
  <header>
    ...
    <nav >
            ...
            <p>NOMBRES</p>
            <input class="form-control" type="text" value= <?php  echo $row['Fecha_exp'] ?> aria-label="readonly input example" readonly>
            <p>APELLIDOS</p>
