...
<option value="ZW">Zimbabue</option>
        ...
        <p>CORREO</p>
        <input type="text" class="form-control mb-3" name="Mail" placeholder="Correo electronico">
        <p>CONTRASEÑA</p>
...
        <label for="user login">GENERO<br>
        ...
        <br><br>
        <label for="user login">TIPO DE USUARIO<br>
        <br>
        ...
        <input type="text" class="form-control mb-1" name="busq" placeholder="INGRESE ID QUE DESEA BUSCAR" >
        
        <input  type="submit" name="buscar" class="btn_search" value="Buscar"></input>
        <a class="btn btn-outline-primary" href="Admin.php" role="button">Regresar</a>
...
while ($reg = $consulta->fetch_array(MYSQLI_BOTH)){
    ...
    ?>
            <tr>
                 ...
                 <th><?php echo $reg['Name'] ?></th>
                 <th><?php echo $reg['Lastname'] ?></th>
                 <th><?php echo $reg['Gender'] ?></th>
                 <th><?php echo $reg['Country'] ?></th>
                 <th><?php echo $reg['Company'] ?></th>
                 <th><?php echo $reg['Mail'] ?></th>
                 <th><?php echo $reg['FechaInicio'] ?></th>
                 <th ><?php echo $reg['FechaFinal'] ?></th>
                 <th><?php echo $reg['Id_rol'] ?></th>
                 <th ><?php echo $reg['Aprovado'] ?></th>
                 <th>
                    
                 <?php
          $datetime1 = date_create(date('Y-m-d'));    
          $datetime2 = date_create($reg['FechaFinal']);   
    ...
    ?>
                 ...
                 <th><a href="Actudat.php?id=<?php echo $reg['Id'] ?> " class="btn btn" style="background-color:rgb(205,220,57,255)">EDITAR</a></th>
                 <th><a href="Borrardat.php?id=<?php echo $reg['Id'] ?> " class="btn btn" style="background-color:rgb(254,193,7,255)" onclick="return confirm('Estás seguro que deseas eliminar el registro?');">ELIMINAR</a></th>
                 <th><a href="Historialadm.php?id=<?php echo $reg['Id'] ?> " class="btn btn" style="background-color:rgb(80,137,242,255)">REGISTROS</a></th>
